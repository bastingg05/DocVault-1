  ...
  return (
    <div className="container auth-page" style={{display:'grid', placeItems:'center'}}>
      <form onSubmit={onSubmit} className="panel auth-card" style={{maxWidth:880}}>
        ...
        <div className="row"><button className="btn btn-block" style={{height:48, fontSize:15, display:'flex', alignItems:'center', justifyContent:'center', padding:0, lineHeight:1}} disabled={loading}>{loading ? 'Creating…' : 'Create account'}</button></div>
